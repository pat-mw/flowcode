/**
 * StylingControlSection Webflow Component Wrapper
 * Showcases design system integration and styling control
 */
...
import StylingControlSection, { type StylingControlSectionProps } from '@/components/webcn/landing_page/webcn.webflow.io/StylingControlSection';
import { WebflowProvidersWrapper } from '@/lib/webflow/providers';
import '@/components/webcn/landing_page/webcn.webflow.io/webcn-landing.css';

export function StylingControlSectionWrapper({
  badgeText,
  sectionTitle,
  sectionSubtitle,
  feature1Title,
...
export default declareComponent(StylingControlSectionWrapper, {
