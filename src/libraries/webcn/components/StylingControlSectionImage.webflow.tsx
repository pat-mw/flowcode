...
type StylingControlSectionImageWrapperProps = {
  image?: PropValues[PropType.Image]; // Webflow Image prop returns { src: string; alt?: string }
} & Omit<StylingControlSectionImageProps, 'imageSrc' | 'imageAlt'>;
...
export function StylingControlSectionImageWrapper({
  ...
  feature3Description,
  showBadge,
}: StylingControlSectionImageWrapperProps) {
  return (
...
export default declareComponent(StylingControlSectionImageWrapper, {
  ...
  props: {
    image: props.Image({
      name: 'Demo Image',
      group: 'Content',
      tooltip: 'Select an image or GIF from your Webflow asset library to showcase the styling/theming demo',
    }),
